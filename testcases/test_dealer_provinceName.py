...
class dealerProvinceNameCheck(unittest.TestCase):
    maxDiff = None
    ...
    successData = loadTestData("dealer_provinceName_success.xlsx")
    ...
    failData = loadTestData("dealer_provinceName_fail.xlsx")
